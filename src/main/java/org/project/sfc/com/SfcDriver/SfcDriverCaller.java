...
public class SfcDriverCaller  {
    ...
    public SfcDriverCaller(String type) {
    ...
    public void UpdateChainsPaths(VirtualNetworkFunctionRecord vnfr){
        ...
        while (it.hasNext()) {
                    ...
                    if(VNFs.get(VNFcounter.getKey()).getName().equals(getFaildVNFname(vnfr))){
                        ...
                        if(getActiveVNF(vnfr)!=null){
                            ...
                            for ( Ip ip:getActiveVNF(vnfr).getIps()) {
                                ...
                                System.out.println("[Adjustted the IP and Neutron port ID of new SF ] " + newVnf.getIP() +" , "+ newVnf.getNeutronPortId() );
            ...
            String new_instance_id=SFC_driver.CreateSFP(All_SFCs.get(SFCdata_counter.getKey()).getSFCdictInfo(), VNFs);
            ...
            String SFCC_name=SFC_Classifier_driver.Create_SFC_Classifer(All_SFCs.get(SFCdata_counter.getKey()).getClassifierInfo(),new_instance_id);
...
*/
    ...
    /*    if(vnffgr==null) {
     ...
     /*   if(vnffgr==null) {
        ...
        sfcc_db.add(vnffgr.getId(), instance_id, sfcc_dict.getName(),sfc_dict_test.getSymmetrical(),vnfdicts,sfc_test,sfcc_dict);
