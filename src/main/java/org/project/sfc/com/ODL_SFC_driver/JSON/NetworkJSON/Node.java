...
public class Node {
    ...
    @Expose
    private List<OvsdbBridgeExternalId> ovsdbBridgeExternalIds = new ArrayList<OvsdbBridgeExternalId>();
    ...
    @Expose
    private List<OvsdbBridgeOtherConfig> ovsdbBridgeOtherConfigs = new ArrayList<OvsdbBridgeOtherConfig>();
    ...
    @Expose
    private List<OvsdbOpenvswitchOtherConfig> ovsdbOpenvswitchOtherConfigs = new ArrayList<OvsdbOpenvswitchOtherConfig>();
    @SerializedName("ovsdb:managed-node-entry")
    @Expose
    private List<OvsdbManagedNodeEntry> ovsdbManagedNodeEntry = new ArrayList<OvsdbManagedNodeEntry>();
    ...
    /**
     * 
     * @param ovsdbManagedBy
     *     The ovsdb:managed-by
     */
    ...
    /**
     * 
     * @param ovsdbBridgeUuid
     *     The ovsdb:bridge-uuid
     */
    ...
    /**
     * 
     * @param ovsdbBridgeName
     *     The ovsdb:bridge-name
     */
    ...
    /**
     * 
     * @param ovsdbDatapathId
     *     The ovsdb:datapath-id
     */
    ...
    /**
     * 
     * @param ovsdbBridgeExternalIds
     *     The ovsdb:bridge-external-ids
     */
    ...
    /**
     * 
     * @param ovsdbDatapathType
     *     The ovsdb:datapath-type
     */
    ...
    /**
     * 
     * @param ovsdbProtocolEntry
     *     The ovsdb:protocol-entry
     */
     ...
     * 
     * @return
     *     The ovsdbBridgeOpenflowNodeRef
     */
    ...
    /**
     * 
     * @param ovsdbBridgeOpenflowNodeRef
     *     The ovsdb:bridge-openflow-node-ref
     */
    ...
    /**
     * 
     * @param ovsdbBridgeOtherConfigs
     *     The ovsdb:bridge-other-configs
     */
    ...
    /**
     * 
     * @param ovsdbControllerEntry
     *     The ovsdb:controller-entry
     */
     ...
     * 
     * @return
     *     The ovsdbOpenvswitchOtherConfigs
     */
    ...
    /**
     * 
     * @param ovsdbOpenvswitchOtherConfigs
     *     The ovsdb:openvswitch-other-configs
     */
    public void setOvsdbOpenvswitchOtherConfigs(List<OvsdbOpenvswitchOtherConfig> ovsdbOpenvswitchOtherConfigs) {
    ...
    /**
     * 
     * @param ovsdbManagedNodeEntry
     *     The ovsdb:managed-node-entry
     */
    ...
    /**
     * 
     * @param ovsdbManagerEntry
     *     The ovsdb:manager-entry
     */
    ...
    /**
     * 
     * @param ovsdbConnectionInfo
     *     The ovsdb:connection-info
     */
