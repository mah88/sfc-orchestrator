...
public class RenderedServicePathHop {
  ...
  /**
   *
   * @param serviceFunctionName The service-function-name
   */
  ...
  /**
   *
   * @return The serviceFunctionForwarderLocator
   */
  ...
  /**
   *
   * @param serviceFunctionForwarderLocator The service-function-forwarder-locator
   */
