...
public class ServiceFunctionForwarder {
  ...
  @Expose
  private List<ServiceFunctionDictionary> serviceFunctionDictionary =
      new ArrayList<ServiceFunctionDictionary>();
   ...
   */
  public void setServiceFunctionForwarderOvsOvsNode(
      ServiceFunctionForwarderOvsOvsNode servicefunctionforwarderOvsOvsNode) {
  ...
  /**
   *
   * @return The serviceFunctionForwarderOvsOvsBridge
   */
  ...
  /**
   *
   * @param serviceFunctionForwarderOvsOvsBridge The service-function-forwarder-ovs:ovs-bridge
   */
  public void setServiceFunctionForwarderOvsOvsBridge(
      ServiceFunctionForwarderOvsOvsBridge serviceFunctionForwarderOvsOvsBridge) {
    this.serviceFunctionForwarderOvsOvsBridge = serviceFunctionForwarderOvsOvsBridge;
  }

  /**
   *
   * @return The serviceFunctionDictionary
   */
  ...
  /**
   *
   * @param serviceFunctionDictionary The service-function-dictionary
   */
  public void setServiceFunctionDictionary(
      List<ServiceFunctionDictionary> serviceFunctionDictionary) {
    this.serviceFunctionDictionary = serviceFunctionDictionary;
  }

  /**
   *
   * @return The sffDataPlaneLocator
   */
  ...
  /**
   *
   * @param sffDataPlaneLocator The sff-data-plane-locator
   */
