...
public class Port {
  ...
  /**
   *
   * @param bindingHostId The binding:host_id
   */
  ...
  /**
   *
   * @param allowedAddressPairs The allowed_address_pairs
   */
  ...
  /**
   *
   * @param extraDhcpOpts The extra_dhcp_opts
   */
  ...
  /**
   *
   * @param dnsAssignment The dns_assignment
   */
  ...
  /**
   *
   * @param deviceOwner The device_owner
   */
  ...
  /**
   *
   * @param portSecurityEnabled The port_security_enabled
   */
  ...
  /**
   *
   * @param bindingProfile The binding:profile
   */
  ...
  /**
   *
   * @param securityGroups The security_groups
   */
  ...
  /**
   *
   * @param adminStateUp The admin_state_up
   */
  ...
  /**
   *
   * @param networkId The network_id
   */
  ...
  /**
   *
   * @param bindingVifDetails The binding:vif_details
   */
  ...
  /**
   *
   * @param bindingVnicType The binding:vnic_type
   */
  ...
  /**
   *
   * @param bindingVifType The binding:vif_type
   */
